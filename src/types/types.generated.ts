...
export type ResolversTypes = {
  ...
  FileConnection: ResolverTypeWrapper<Omit<FileConnection, 'items'> & { items: Array<ResolversTypes['File']> }>;
  FileStatus: ResolverTypeWrapper<'PENDING' | 'UPLOADED' | 'FAILED' | 'DELETED'>;
  FilesFilterInput: FilesFilterInput;
  Folder: ResolverTypeWrapper<Omit<Folder, 'children' | 'files'> & { children?: Maybe<Array<ResolversTypes['Folder']>>, files?: Maybe<Array<ResolversTypes['File']>> }>;
  FolderConnection: ResolverTypeWrapper<Omit<FolderConnection, 'items'> & { items: Array<ResolversTypes['Folder']> }>;
  FolderFilterInput: FolderFilterInput;
  Init2faResponse: ResolverTypeWrapper<Init2faResponse>;
  JSON: ResolverTypeWrapper<Scalars['JSON']['output']>;
  LoginInput: LoginInput;
  MfaSettings: ResolverTypeWrapper<Omit<MfaSettings, 'method'> & { method?: Maybe<ResolversTypes['TwoFactorMethod']> }>;
  ...
  User: ResolverTypeWrapper<Omit<User, 'mfaSettings'> & { mfaSettings?: Maybe<ResolversTypes['MfaSettings']> }>;
};
...
export type ResolversParentTypes = {
  ...
  FilesFilterInput: FilesFilterInput;
  Folder: Omit<Folder, 'children' | 'files'> & { children?: Maybe<Array<ResolversParentTypes['Folder']>>, files?: Maybe<Array<ResolversParentTypes['File']>> };
  FolderConnection: Omit<FolderConnection, 'items'> & { items: Array<ResolversParentTypes['Folder']> };
  FolderFilterInput: FolderFilterInput;
...
export type FileStatusResolvers = EnumResolverSignature<{ DELETED?: any, FAILED?: any, PENDING?: any, UPLOADED?: any }, ResolversTypes['FileStatus']>;
...
export type Init2faResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['Init2faResponse'] = ResolversParentTypes['Init2faResponse']> = {
...
export type MfaSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['MfaSettings'] = ResolversParentTypes['MfaSettings']> = {
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  cancelUpload?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationcancelUploadArgs, 'fileId'>>;
  confirm2faEnrollment?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<Mutationconfirm2faEnrollmentArgs, 'secret' | 'token'>>;
  confirmUpload?: Resolver<ResolversTypes['File'], ParentType, ContextType, RequireFields<MutationconfirmUploadArgs, 'fileId'>>;
  createFolder?: Resolver<ResolversTypes['Folder'], ParentType, ContextType, RequireFields<MutationcreateFolderArgs, 'input'>>;
  createShareLink?: Resolver<ResolversTypes['ResourceShareLink'], ParentType, ContextType, RequireFields<MutationcreateShareLinkArgs, 'input'>>;
  deleteFiles?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationdeleteFilesArgs, 'ids'>>;
  deleteFolder?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationdeleteFolderArgs, 'id'>>;
  deleteShareLink?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationdeleteShareLinkArgs, 'id'>>;
  disable2fa?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<Mutationdisable2faArgs, 'password'>>;
  forgotPassword?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationforgotPasswordArgs, 'email'>>;
  googleLogin?: Resolver<ResolversTypes['AuthPayload'], ParentType, ContextType, RequireFields<MutationgoogleLoginArgs, 'token'>>;
  init2faEnrollment?: Resolver<ResolversTypes['Init2faResponse'], ParentType, ContextType, RequireFields<Mutationinit2faEnrollmentArgs, 'method'>>;
  login?: Resolver<ResolversTypes['AuthPayload'], ParentType, ContextType, RequireFields<MutationloginArgs, 'data'>>;
  moveFolder?: Resolver<ResolversTypes['Folder'], ParentType, ContextType, RequireFields<MutationmoveFolderArgs, 'id'>>;
  renameFolder?: Resolver<ResolversTypes['Folder'], ParentType, ContextType, RequireFields<MutationrenameFolderArgs, 'id' | 'name'>>;
  requestUploadUrl?: Resolver<ResolversTypes['SignedUploadUrl'], ParentType, ContextType, RequireFields<MutationrequestUploadUrlArgs, 'input'>>;
  ...
  signup?: Resolver<ResolversTypes['AuthPayload'], ParentType, ContextType, RequireFields<MutationsignupArgs, 'data'>>;
  toggleFilePublic?: Resolver<ResolversTypes['File'], ParentType, ContextType, RequireFields<MutationtoggleFilePublicArgs, 'id'>>;
  verify2FA?: Resolver<ResolversTypes['AuthPayload'], ParentType, ContextType, RequireFields<Mutationverify2FAArgs, 'token'>>;
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  getFileDownloadUrl?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<QuerygetFileDownloadUrlArgs, 'id'>>;
  getFileShareLinks?: Resolver<Array<ResolversTypes['ResourceShareLink']>, ParentType, ContextType, RequireFields<QuerygetFileShareLinksArgs, 'fileId'>>;
  getFiles?: Resolver<ResolversTypes['FileConnection'], ParentType, ContextType, Partial<QuerygetFilesArgs>>;
  getFolder?: Resolver<Maybe<ResolversTypes['Folder']>, ParentType, ContextType, RequireFields<QuerygetFolderArgs, 'id'>>;
  getFolderShareLinks?: Resolver<Array<ResolversTypes['ResourceShareLink']>, ParentType, ContextType, RequireFields<QuerygetFolderShareLinksArgs, 'folderId'>>;
  getFolders?: Resolver<ResolversTypes['FolderConnection'], ParentType, ContextType, Partial<QuerygetFoldersArgs>>;
  me?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
};

export type ResourceShareLinkResolvers<ContextType = any, ParentType extends ResolversParentTypes['ResourceShareLink'] = ResolversParentTypes['ResourceShareLink']> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type TwoFactorMethodResolvers = EnumResolverSignature<{ AUTHENTICATOR?: any, EMAIL?: any }, ResolversTypes['TwoFactorMethod']>;
